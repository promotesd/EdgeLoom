...
class FrozenOpenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, arch="ViT-H-14", version="/ceph-data/drm/code/FreestyleNet-main/download/laion/laion2b_s32b_b79k/open_clip_pytorch_model.bin", device="cuda", max_length=77,
